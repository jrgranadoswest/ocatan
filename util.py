...
def generate_new_board(num_players=4):
    ...
    new_brd = {
        ...
        #     0,
        # ],
        # Map dice sums to the players who receive resources from them
        # dice sum - 2 = idx
        # Each time a new settlement or city is placed, this map is updated
        # This map is used in conjunction with location of robber to determine who gets robbed (TODO)
        # players can have more than 6 resources of the same type from one roll, so this has to account for that
        # list of lists: each list is a list of players who get resources from that dice sum
    }
